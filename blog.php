...
<body class="bg-surface text-on-surface">
    <!-- TopNavBar -->
    <header class="bg-surface/90 backdrop-blur-md dark:bg-on-surface/90 border-b border-outline-variant/30 shadow-sm fixed top-0 sticky z-50 w-full">
        <nav class="flex justify-between items-center h-[72px] px-margin-desktop max-w-container-max mx-auto w-full">
            <div class="flex items-center gap-8">
                <a class="font-headline-md text-headline-md font-bold text-primary dark:text-primary-fixed" href="index.php">EnterpriseCore</a>
                <div class="hidden md:flex gap-6">
                    ...
                    <a class="font-body-md text-body-md text-primary border-b-2 border-primary pb-1" href="blog.php">Blog</a>
            ...
            <div class="flex items-center gap-4">
                <form action="blog.php" method="GET" class="hidden lg:flex items-center bg-surface-container-low px-4 py-2 rounded-full border border-outline-variant/20">
                    <span class="material-symbols-outlined text-on-surface-variant text-[20px]">search</span>
                    <input class="bg-transparent border-none focus:ring-0 text-label-md ml-2 w-48 outline-none" placeholder="Search insights..." type="text" name="search" value="<?php echo htmlspecialchars($search); ?>"/>
                    <?php if ($category !== 'all'): ?>
                        <input type="hidden" name="category" value="<?php echo htmlspecialchars($category); ?>">
                    <?php endif; ?>
                </form>
                <a href="request-quote.php" class="bg-primary text-on-primary px-6 py-2.5 rounded-lg font-label-md hover:bg-primary/90 transition-all active:scale-95 text-center">Request Quote</a>
            </div>
        </nav>
    </header>
