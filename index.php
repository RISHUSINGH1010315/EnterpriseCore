...
<!-- Hero Section -->
    <header class="relative overflow-hidden bg-surface-container-lowest pt-20 pb-0">
        ...
        <div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop relative z-10 flex flex-col gap-16">
            ...
            <div class="flex flex-col items-center text-center space-y-8 max-w-3xl mx-auto w-full">
                ...
                <h1 class="font-display-lg text-3xl md:text-display-lg leading-tight text-center">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4 pt-4 w-full sm:w-auto">
                    <a href="request-quote.php" class="bg-primary text-on-primary px-8 py-4 rounded-xl font-headline-md text-body-md hover:shadow-xl transition-all hover:-translate-y-1 text-center flex items-center justify-center min-h-[48px] w-full sm:w-auto">Get Started</a>
                    <a href="case-studies.php" class="border border-outline-variant text-primary px-8 py-4 rounded-xl font-headline-md text-body-md hover:bg-surface-container-high transition-all text-center flex items-center justify-center min-h-[48px] w-full sm:w-auto">View Portfolio</a>
                </div>
            </div>
        </div>
        <!-- Showcase Video Banner (Full Screen Edge-to-Edge Width) -->
        <div class="w-full mt-16 relative z-10">
            <div class="w-full aspect-video md:aspect-[21/9] bg-surface-container-high overflow-hidden shadow-2xl">
    ...
    <section class="bg-surface-container py-20">
        <div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-gutter text-center">
                ...
                <div class="p-8 border-y md:border-y-0 md:border-x border-outline-variant/30">
    ...
    <section class="py-section-padding bg-surface">
        <div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
            <div class="mb-16 text-center max-w-2xl mx-auto">
                <h2 class="font-headline-xl text-headline-md md:text-headline-xl mb-6">Strategic Digital Services</h2>
        ...
        <div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
            <div class="grid lg:grid-cols-2 gap-20 items-center">
                <div class="space-y-12">
                    <div>
                        <h2 class="font-headline-xl text-headline-md md:text-headline-xl mb-6">Why Industry Leaders Choose EnterpriseCore</h2>
    ...
    <footer class="bg-surface-container-lowest border-t border-outline-variant">
        ...
        <div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-8 border-t border-outline-variant/30 flex flex-col md:flex-row justify-between items-center gap-4">
