...
<body class="bg-background text-on-background font-body-md selection:bg-primary/20 selection:text-primary">
    <!-- Top Navigation Bar -->
    <header class="bg-surface/90 backdrop-blur-md sticky top-0 z-50 border-b border-outline-variant/30 shadow-sm transition-shadow duration-300">
        <div class="flex justify-between items-center h-[72px] px-margin-desktop max-w-container-max mx-auto w-full">
            ...
            <nav class="hidden md:flex items-center gap-8">
                ...
                <a class="font-body-md text-body-md text-primary border-b-2 border-primary pb-1" href="industries.php">Industries</a>
            ...
            <div class="flex items-center gap-gutter">
                <a href="request-quote.php" class="hidden md:block bg-primary text-on-primary px-6 py-2.5 rounded-lg font-label-md text-label-md hover:shadow-md transition-all active:scale-95 text-center">Request Quote</a>
